...
public:
    ...
    void BindDebugShadowMap(Renderer& renderer) const;  // ShadowMapデバッグ用
...
private:
    ...
    void CreateDebugShadowMapShaders(Renderer& renderer);   // ShadowMapデバッグ用
...
private:
    ...
    // ShadowMapデバッグ用
    Microsoft::WRL::ComPtr<ID3D11VertexShader> m_debugShadowMapVertexShader;
    Microsoft::WRL::ComPtr<ID3D11PixelShader>  m_debugShadowMapPixelShader;
    // 共通
